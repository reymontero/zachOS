...
then
	echo ">>> Creating new ZachOS floppy image..."
	mkdosfs -C disk_images/ZachOS.flp 1440 || exit
fi
...
echo ">>> Copying ZachOS kernel and programs..."
...
echo ">>> Creating ZachOS CD-ROM ISO image..."

rm -f disk_images/zachos.iso
mkisofs -quiet -V 'ZachOS' -input-charset iso8859-1 -o disk_images/zachos.iso -b mikeos.flp disk_images/ || exit
