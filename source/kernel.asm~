...
; ==================================================================
	...
	%DEFINE ZACHOS_VER '0.1'	; OS version number
	%DEFINE ZACHOS_API_VER 16	; API version for programs to check
        %DEFINE MIKEOS_VER '4.4'	; OS version number
	%DEFINE MIKEOS_API_VER 16
...
option_screen:
	...
	mov cx, 00000010b		; Colour: Green text on Black
	...
	os_init_msg		db 'Welcome to ZACHOS', 0
	os_version_msg		db 'Version ', ZACHOS_VER, 0

	dialog_string_1		db 'Hey There Thanks for trying out ZACHOS!', 0
	dialog_string_2		db 'Please choose an interface: OK for the', 0
	dialog_string_3		db 'main menu, Cancel for the Terminal.', 0
        dialog_string_4         db 'https://sourceforge.net/projects/zachos/',0
